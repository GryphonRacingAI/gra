...
# This node operates similar to lap counter by drawing a line connecting large orange cones and detecting cross product sign change, but doesn't compare line segment distance
...
class LapCounter:
    def __init__(self):
        rospy.init_node('acceleration_finish', anonymous=False)
